...
from .model import build_model, build_TES_model
...
def load_TES_CLIP(name,n_ctx, download_root=None,  use_proj = True ):
    if name in _MODELS:
    ...
    model = build_TES_model(state_dict,n_ctx,use_proj)
